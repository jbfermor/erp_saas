class ApplicationController < ActionController::Base
  ...
  # Opcional: verificar que el usuario pertenece a la company actual
  before_action :authorize_tenant_user
  ...
  def authorize_tenant_user
    ...
    unless current_user.company_id == current_company.id
      ...
      redirect_to root_url(subdomain: current_tenant.subdomain), alert: "No tienes acceso a este tenant"
    end
  end
end
