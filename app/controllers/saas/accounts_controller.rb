module Saas
  class AccountsController < Saas::BaseController
    ...
    def create
      ...
      if @account.save
        ...
        redirect_to saas_account_path(@account), notice: "Account creada correctamente."
      else
    ...
    def update
      if @account.update(account_params)
        redirect_to saas_account_path(@account), notice: "Account actualizada."
      else
